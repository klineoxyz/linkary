...
(function() {
  ...
  console.error = function() {
    if (!shouldSuppress(arguments)) {
      return originalMethods.error.apply(console, arguments);
    }
  };
  
  console.log = function() {
    if (!shouldSuppress(arguments)) {
      return originalMethods.log.apply(console, arguments);
    }
  };
})();
...
import linkaryIconWhite from "figma:asset/083db94d0365b126fe9685504522b53924bdedbb.png";
import linkaryLogoGradient from "figma:asset/a640b6b9d7daccda5668a931d484cc5957416588.png";
import {
  BadgeCheck,
  Bell,
  Briefcase,
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        >
          <img src={linkaryIconWhite} alt="Linkary" className="h-6 w-auto" />
