...
import { maxPlanKey, planKeyFromSubscriptionRow, type PlanKey } from "@/lib/planKey";

const CHUNK = 120;

/**
 * Effective commercial plan for a profile: active profile subscription ∪ active org subscriptions
 * for orgs this user belongs to (any org_members role). Service-role client required for full merge.
 */
