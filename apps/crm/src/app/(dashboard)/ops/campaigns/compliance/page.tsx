...
export default async function OpsCampaignsCompliancePage() {
  ...
  return (
    <div className="space-y-6">
      <header className="crm-page-header">
        <h1 className="crm-page-title">Follow compliance</h1>
        <p className="crm-page-subtitle">
          Same participant sample as the Participants tab, ordered for X follow attestation / verification review. JSON is exact stored
          values — interpret with campaign follow_rules.
        </p>
      </header>
        ...
        <table className="w-full text-sm min-w-[960px]">
          <thead>
            <tr className="text-left text-[var(--crm-muted)] border-b border-[var(--crm-border)]">
              ...
              <th className="py-2 pr-2">x_follow_attestation</th>
              <th className="py-2">x_follow_verification</th>
            </tr>
          </thead>
          <tbody>
            {participants.map((p) => (
