        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setOpen(false)}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="description" className="block text-sm font-medium text-[var(--crm-primary)] mb-1">
                  Description
                </label>
                <textarea
                  id="description"
              ...
              <div>
                <label htmlFor="platform" className="block text-sm font-medium text-[var(--crm-primary)] mb-1">
                  Platform
                </label>
                <input
                  id="platform"
              ...
              <div>
                <label htmlFor="due_at" className="block text-sm font-medium text-[var(--crm-primary)] mb-1">
                  Due date
                </label>
                <input
                  id="due_at"
