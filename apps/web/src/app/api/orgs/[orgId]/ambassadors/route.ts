/**
 * GET: List org ambassadors with profile (username, display_name). Auth required; RLS on org_ambassadors.
 */
...
export async function GET(
  ...
  if (list.length === 0) return ok({ ambassadors: [] });
