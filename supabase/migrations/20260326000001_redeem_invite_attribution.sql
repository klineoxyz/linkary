-- Update redeem_invite_code: set redeemed_by_user_id/redeemed_at on invite_codes; insert invite_attributions for lineage/attribution.
-- Does not change redeem logic or profile.inviter_id behavior.
...
COMMENT ON FUNCTION public.redeem_invite_code IS 'Redeem by one-time code or personal_invite_code. Sets redeemed_by_user_id/redeemed_at on codes; inserts invite_attributions.';
